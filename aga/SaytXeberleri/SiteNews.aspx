<%@ page language="VB" autoeventwireup="false" inherits="aga_FutbolXeberleri_fNews, App_Web_sitenews.aspx.5f0c6dee" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Administration::Add Site News</title>
</head>
<body>
        ...
        <table style="vertical-align: middle; width: 619px; height: 309px; text-align: center">
            <tr>
                <td colspan="2" style="font-size: 11pt; color: white; font-family: Tahoma; height: 30px;
                    ...
                    <strong>Sayt Xəbərləri</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="height: 26px">
                    <asp:Button ID="btnAddSiteNews" runat="server" Font-Bold="True" Height="46px"
